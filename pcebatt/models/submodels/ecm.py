...
class ECM(Model):
    ...
    def __init__(self, config = None):
        ...
        self.interpolator = BatteryParameterInterpolator(self.config)
...
class nRC(ECM):
    ...
    def __init__(self, N: int = 2, logger_level: str = 'DEBUG', config = None):
...
class GalerkinPCE(ECM):
    ...
    def __init__(self, logger_level: str = 'DEBUG', config = None):
    ...
    def get_output_expansion(self) -> Tuple[NDArray[chaospy.polynomial], chaospy.J]:
